...
<p>If you have any questions about these terms and conditions, please contact us via email at <img style="vertical-align: bottom" src="<?php echo WWW; ?>/img/privacy/lawcontact.gif" alt=""/> and do not use the site until you are satisfied with and can accept these terms and conditions in full.</p>
<p>
<b>
Changes</b><br/>
...
<p>Parents can find more information about the game and how to contact us in the <a href="<?php echo WWW; ?>/parents" target="_blank">Parents' Guide</a>.</p>
<p>
<b>
Safety / abuse</b><br/>
Before using any Jagex Product you should read the guides found in our <a href="<?php echo WWW; ?>/kbase/guid/safety_and_security_guidelines">Safety &amp; Security Guidelines</a>. It is particularly important to read the <a href="<?php echo WWW; ?>/kbase/guid/play_safely">Play Safely Guide</a> and the
<a href="<?php echo WWW; ?>/kbase/guid/health_amp_safety">Health &amp; Safety Guide</a>.
Parents should review our safety materials in the <a href="<?php echo jagex; ?>/corporate/Parents_Guide/safety" target="_blank">Player Safety</a> section of the <a href="<?php echo jagex; ?>/corporate/Parents_Guide/parents_guide" target="_blank">Parents' Guide</a>.</p>
...
<p>If you are the victim of offensive or inappropriate behaviour or receive any other unwanted communications, you should use the built-in facilities to block the messages. (See <a href="<?php echo WWW; ?>/kbase/guid/controls_friends">this article</a> for guidance on blocking messages.) You should report all inappropriate behaviour to us via the in game <a href="<?php echo WWW; ?>/kbase/guid/how_do_i_report_abuse">"Report abuse"</a> button as well as seeking appropriate external help, for example from parents or law enforcement authorities. If you continue to suffer problems, or are not satisfied, then you must stop using the relevant Jagex Product(s).</p>
<p>
<b>
Your account</b><br/>
...
<p>Payments by credit cards are also subject to our <a href="<?php echo WWW; ?>/kbase/guid/credit_card_payment#agreeing">credit card agreement</a> which forms part of these terms and conditions.</p>
...
You may cancel your subscription at any time by <a href="<?php echo WWW; ?>/billing_core/unsubscribe">clicking here</a> or selecting the "Cancel Subscription" link from the account management section on the website of any Jagex Product.</p>
...
<b>
Privacy policy</b><br/>
For a description of how we use your personal data, please see our <a href="<?php echo WWW; ?>/privacy/privacy">Privacy policy</a>.</p>
<p>
<b>
